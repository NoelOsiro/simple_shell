...
char *my_err_env(char **args)
{
	...
	args--;
	len = my_strlen(my_name) + my_strlen(ctr_str) + my_strlen(args[0]) + 45;
...
char *my_err_1(char **args)
{
	...
	len = my_strlen(my_name) + my_strlen(args[0]) + 13;
	error = malloc(sizeof(char) * (len + 1));
	if (!error)
		return (NULL);
...
char *my_err_2(char **args)
{
	...
	len = my_strlen(my_name) + my_strlen(ctr_str) + my_strlen(args[0]) + 27;
	error = malloc(sizeof(char) * (len + 1));
	if (!error)
	{
		free(ctr_str);
...
char *my_err_4(char **args)
{
	...
	len = my_strlen(my_name) + my_strlen(ctr_str) + my_strlen(args[0]) + 33;
	error = malloc(sizeof(char) * (len + 1));
	if (!error)
	{
		free(ctr_str);

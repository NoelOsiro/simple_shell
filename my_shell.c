 ...
 * It then forks a new process to execute the command using the `execvp()` function,
 * which searches for the command in the directories listed in the PATH environment variable.
 *
